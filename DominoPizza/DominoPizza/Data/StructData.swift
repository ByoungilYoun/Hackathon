...
let menuData : [Menu] = [
  Menu(category: "슈퍼시드", products: [
    ...
    Product(name: "알로하 하와이안", price: 12000),
    Product(name: "우리 고구마", price: 11000),
    Product(name: "콰트로 치즈 퐁듀", price: 12000),
  ]),
  Menu(category: "프리미엄", products: [
      Product(name: "더블크러스트 이베리코", price: 12000),
      Product(name: "블랙앵거스 스테이크", price: 11000),
